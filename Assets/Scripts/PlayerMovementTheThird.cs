...
public class PlayerMovementTheThird : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (movement.x < 0)
        {
            transform.localScale = new Vector3((float)-0.6, (float)0.6, 1); // Face left
        }
        else if (movement.x > 0)
        {
            transform.localScale = new Vector3((float)0.6, (float)0.6, 1); // Face right
        }
